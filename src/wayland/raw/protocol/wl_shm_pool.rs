...
pub static WL_SHM_POOL_CREATE_BUFFER: uint32_t = 0;
pub static WL_SHM_POOL_DESTROY: uint32_t = 1;
pub static WL_SHM_POOL_RESIZE: uint32_t = 2;
...
pub unsafe fn wl_shm_pool_set_user_data(
    ...
    raw::wl_proxy_set_user_data(
        wl_shm_pool as *mut objects::wl_proxy, user_data
    );
}
...
#[inline]
pub unsafe fn wl_shm_pool_destroy(wl_shm_pool: *mut objects::wl_shm_pool) {
